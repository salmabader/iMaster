...
<body class="overflow-x-hidden h-screen w-screen">
    <main class="flex w-full h-full">
        <!-- left side -->
        <div class="flex flex-col lg:w-1/5 lg:block hidden h-full mr-4">
	...
	c-7.6-3.1-15.4-6.3-22.1-10.8c-19.4-13-39.9-12.9-61.2-6.6C56.2-22.4,41-15,26.6-5.9C25-4.9,23.6-3.1,20.9-3.5z" />
		...
		s-2.1-1.6-3.7-1.6c-1.6,0-3,0.6-4.1,1.6C1053.8,196.7,1053.3,198.3,1053.3,200.3z" />
                    ...
                    <!-- options -->
                    <div class="max-w-1/2 flex flex-col text-gray-700 font-semibold text-lg">
                        ...
                        <div class="hover:text-blue-800 duration-100 ease-in-out mb-5">
                            <a href="" class="hover:border-l-[3px] duration-100 ease-in-out hover:border-l-amber-500 flex items-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                </svg><span id="linkTitle">Courses</span></a>
                        </div>
                    </div>
                </div>
                <!-- sign out button -->
                <div class="mb-10">
                    <button class="bg-blue-100 hover:bg-blue-200 duration-200 ease-in-out px-8 py-2 text-blue-800 rounded-xl">Sign
                        out <svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clip-rule="evenodd" />
                        </svg></button>
                </div>
                <div class="absolute -right-4 bottom-1/2 flex items-center bg-white hover:bg-amber-400 hover:text-white hover:cursor-pointer duration-150 ease-in-out rounded-full border-gray-200 border-2 p-1 text-gray-700">
        ...
        <!-- right side -->
        <div class="lg:w-4/5 lg:mx-0 mx-5 w-full h-full">
