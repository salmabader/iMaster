...
<body class="overflow-x-hidden h-screen w-full">
    <main class="h-full w-full flex">
        <!-- left side -->
        <div class="mr-2 w-1/6 md:block hidden">
            <div class="flex flex-col justify-between h-full bg-gray-50 border-r-[1px] border-gray-200 pb-8 pl-10">
                <!-- col 1 -->
                <div class="pr-10 relative">
                    <!-- logo -->
                    <svg class="h-12 mt-5 mb-10" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1075.7 353.7" enable-background="new 0 0 1075.7 353.7" xml:space="preserve">
	...
	c-7.6-3.1-15.4-6.3-22.1-10.8c-19.4-13-39.9-12.9-61.2-6.6C56.2-22.4,41-15,26.6-5.9C25-4.9,23.6-3.1,20.9-3.5z" />
		...
		s-2.1-1.6-3.7-1.6c-1.6,0-3,0.6-4.1,1.6C1053.8,196.7,1053.3,198.3,1053.3,200.3z" />
                    ...
                    <!-- options -->
                    <div class="flex flex-col justify-between font-semibold text-lg text-gray-700">
                        <div class="hover:text-blue-800 duration-100 ease-in-out mb-5">
                            <a href="" class="hover:border-l-[3px] duration-100 ease-in-out hover:border-l-amber-500 flex items-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg><span id="linkTitle">Analytics</span></a>
                        </div>
                        <div class="hover:text-blue-800 duration-100 ease-in-out mb-5">
                            <a href="" class="hover:border-l-[3px] duration-100 ease-in-out hover:border-l-amber-500 flex items-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                </svg><span id="linkTitle">Requests</span></a>
                        </div>
                        <div class="hover:text-blue-800 duration-100 ease-in-out mb-5">
                            <a href="" class="hover:border-l-[3px] duration-100 ease-in-out hover:border-l-amber-500 flex items-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                                </svg><span id="linkTitle">Issues</span></a>
                        </div>
                        <div class="hover:text-blue-800 duration-100 ease-in-out mb-5">
                            <a href="" class="hover:border-l-[3px] duration-100 ease-in-out hover:border-l-amber-500 flex items-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                </svg><span id="linkTitle">All courses</span></a>
                        </div>
                    </div>
                    <div class="absolute -right-4 top-6 bg-white rounded-full border-gray-200 border-2 p-1 text-gray-700">
                ...
                <!-- col 2 -->
                <div>
                    <button class="bg-blue-100 hover:bg-blue-200 duration-200 ease-in-out w-3/4 px-8 py-2 text-blue-800 rounded-xl">Sign out <svg xmlns="http://www.w3.org/2000/svg" class="h-5 inline" viewBox="0 0 20 20" fill="currentColor">
        ...
        <!-- right side -->
        <div class="md:ml-2 md:w-5/6 w-full">
            <div class="flex flex-col justify-between h-full bg-amber-50">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga suscipit recusandae, minus dolorem eveniet aspernatur hic, provident, libero quidem exercitationem autem non. Excepturi expedita tenetur molestiae labore, debitis quod facere.
            </div>
        </div>
    </main>
</body>
