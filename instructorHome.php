...
<head>
	...
	<link rel="icon" href="images/imaster_icon.svg" type="image/x-icon">
	<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css'>
	<link rel="stylesheet" href="home_notification_button.css">

	<title>iMaster</title>
</head>

<body class="flex  overflow-x-hidden h-screen w-full">


	<!--left section-->
	<div class="bg-amber-200  w-1/4 flex flex-col pt-4 ">
		<!-- logo-->
		<a class="ml-2" href="index.html">

			<svg class="h-8 md:h-14 " version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1075.7 353.7" enable-background="new 0 0 1075.7 353.7" xml:space="preserve">
	...
	c-7.6-3.1-15.4-6.3-22.1-10.8c-19.4-13-39.9-12.9-61.2-6.6C56.2-22.4,41-15,26.6-5.9C25-4.9,23.6-3.1,20.9-3.5z" />
		...
		<div class="flex flex-col  mt-24 text-sm  md:text-2xl font-bold">
			<!-- Home-button -->
			<a href="instructor_home.html" class=" flex  justify-center items-center mb-24  py-2 text-blue-900 bg-amber-400 ">Home
			</a>
			<!-- New Course-button -->
			<a href="instructor_NewCourse_page.html" class=" flex  justify-center items-center  mb-24  py-2  text-blue-900 hover:bg-amber-400">New Course
			</a>
			<!-- Help Center-button -->
			<a href="instructor_helpCenter_page.html" class="flex  justify-center items-center  mb-24  py-2 text-blue-900 hover:bg-amber-400 ">Help Center
			</a>
			<!-- log out -->
			<div class="flex  justify-center items-center "> <button onclick="window.location.href='database/destroy_session.php'" class=" text-xs md:text-sm bg-amber-400  text-gray-900 px-6 py-1  rounded-xl shadow-md border-amber-500 border-2 hover:bg-amber-500 duration-300 ease-in-out">log
					out <svg xmlns="http://www.w3.org/2000/svg" class=" h-3 w-3 md:h-6 md:w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
	...
	<!--right section-->
	<!-- main content -->
	<div class="flex flex-col w-3/4 h-screen bg-amber-100 justify-between ">
		<!--head of the page -->
		<header class="flex  h-1/4 w-full  ">
			<!--part 1-->
			<div class="flex w-1/4 md:w-3/4 pt-1 ">

				<div class="w-1/4">
					<img class=" h-4 w-4 sm:w-7 sm:h-7" style="width: 150px;
					height: 150px;
					object-fit: cover;
					margin: 10px auto;
					border: 10px solid rgba(230, 150, 3, 0.945);
					border-radius: 50%;" src="images/avatar2.png">
				</div>
				<div class="flex flex-col pt-8 pl-3">
					<div class="text-sm md:text-lg font-bold text-gray-800">
						Welcome
					</div>
					<div class="text-sm md:text-lg   text-gray-800">
						Full Name
					</div>
		...
		<!---Your Courses--->
		<div class=" flex flex-col h-1/2 w-full pt-4 ">
			<div class="border-b-2 w-1/2 md:w-1/3  border-gray-200 ">
				<p class="text-sm md:text-lg font-bold text-blue-900 pl-3 ">Your Courses </p>
			</div>
