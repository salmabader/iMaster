...
<body class="h-screen w-screen overflow-hidden">
	...
	<!-- toast msg -->
	<div id="course-submitted" class="opacity-0 flex fixed bottom-5 right-9 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow border border-green-600" role="alert">
		...
		<div class="ml-3 text-sm font-normal" id="submittingMsg"><?php if (isset($successMsg)) echo htmlspecialchars($successMsg) ?></div>
		<button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#course-submitted" aria-label="Close">
