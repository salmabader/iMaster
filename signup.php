        ...
        <div class="lg:w-2/3 w-full flex flex-col lg:mr-4 mr-0">
            ...
            <form action="#" method="POST" class="flex flex-wrap justify-center p-12">
                ...
                <div class="w-1/2 mt-3">
                    ...
                    <input type="text" id="signup_usename" placeholder="_salma" class="w-full mt-1 bg-amber-100 px-6 py-2 rounded-lg border-2 border-amber-200 focus:bg-blue-50 placeholder-gray-400 text-blue-800">
                </div>
                <!-- password -->
                <div class="flex w-1/2">
